...
build/nginx_$(NGINX_VERSION)-1~precise-tizaro_amd64.deb: $(NGINX_SRC)/debian/rules $(NGINX_SRC)/debian/changelog $(SMALL_LIGHT_SRC)/config
...
install: build/nginx_$(NGINX_VERSION)-1~precise-tizaro_amd64.deb
	dpkg -i build/nginx_$(NGINX_VERSION)-1~precise-tizaro_amd64.deb
